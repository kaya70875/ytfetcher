...
class YTFetcher:
    ...
    """
    def __init__(self, max_results: int, video_ids: list[str] | None, channel_handle: str | None = None, proxy_config: ProxyConfig | None = None, http_config: HTTPConfig = HTTPConfig(), languages: Iterable[str] = ("en", )):
